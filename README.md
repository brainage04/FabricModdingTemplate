...
This script is designed to work both with GitHub Actions and manual usage, and will safely delete:
  - Leftover unused folders that are not tracked by Git (such as `src/main/java/io/github/brainage04`, `src/client/java/io/github/brainage04`, and `src/main/resources/fabrictemplateserver`).
